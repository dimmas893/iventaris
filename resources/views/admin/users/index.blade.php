			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
						<button type="button" class="btn btn-sm btn-info mr-1 info"
						...
						<a href="{{ route('admin.member.edit', $user->id) }}" class="btn btn-sm btn-primary mr-1"><i class="fas fa-edit"></i></a> 
	...
	<x-slot name="script">
		<script>
			$('.info').click(function(e) {
				...
				$('#email-modal').text($(this).data('username'))
